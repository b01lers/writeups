...
Now that we have all pieces together we can reconstruct the whole algorithm. I created this program
that generates a valid password for each username:
	...
	// ------------------------------------------------------------------------------------------------
	/*
	** The original program has functions _1st, _2nd, _3rd, _4th and _5th. The only difference betwwe these
	** functions is the number which is added on at the end. I merge all these function in a single one.
	*/
	// ------------------------------------------------------------------------------------------------
	int _ith( int idx )
	{
...
Once we execute it, we get the password:
