...
I apologise for the above code. I reverse it within few hours, so be patient with mistakes... :)
...
###Exploit
    ...
    # ----------------------------------------------------------------------------------
    '''
    ispo@xrysa4 ~/bkp $ python central_square.py
