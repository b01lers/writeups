...
The code below is used to generate the shellcode:

    // --------------------------------------------------------------------------------------------------
    // Contest  : PlaidCTF 2016
    // Date     : 15/04 - 17/02/2016 (48hr)
    // Member   : ispo@b01lers
    // Challenge: fixedpoint (Pwn 175)
    // Description: IEEE754 is useful when your values go from -inf to +inf, but really, fixed point
    //              is all you need.
