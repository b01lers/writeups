...
Below is the code that cracks the hash:
    ...
    # Member   : ispo@b01lers
    # Challenge: quite quixotic quest (Reversing 300)
    # Description: Well yes, it certainly is quite quixotic. (Yes, the flag format is PCTF{} )
    #
    #
